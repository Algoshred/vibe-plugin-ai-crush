 ...
 * vibe-plugin-crush
 *
 * Crush AI agent provider for VibeControls Agent.
...
export const vibePlugin: VibePlugin = {
  ...
  onServerStart(_app, hostServices) {
    hostServices?.telemetry?.emit("ai.provider.ready", { provider: "crush" });
