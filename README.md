...
```bash
vibe plugin install @vibecontrols/vibe-plugin-ai-crush
```

Or install the npm package directly into an existing project that hosts the VibeControls agent:

```bash
bun add @vibecontrols/vibe-plugin-ai-crush
# or
npm install @vibecontrols/vibe-plugin-ai-crush
```
...
- npm: <https://www.npmjs.com/package/@vibecontrols/vibe-plugin-ai-crush>
- Source: <https://github.com/algoshred/vibe-plugin-ai-crush>
- Plugin contract / SDK: <https://github.com/algoshred/vibecontrols-plugin-sdk>
- Plugin catalogue: <https://vibecontrols.com/plugins/ai-crush>
